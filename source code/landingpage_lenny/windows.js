...
// Get all the things with the class container on the page. And add a function called hideContainer
let allWindowHubs = document.getElementsByClassName('window-hub-item window-header');
...
function showWindow() {
  ...
  // to show something on a page, we can change it's display style to visible
  this.style.display = 'none';
